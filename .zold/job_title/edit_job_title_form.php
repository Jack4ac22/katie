...
if ($connect) {
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $query = "SELECT * FROM job_titles WHERE id = $id";
...
?>
<form action="../job_title/edit_job_title.php" method="post">
    <div class="mb-3">
...
<?php
echo "<div class=\"mb-3\"><a href=\"http://localhost:8888/Katie/job_title/display_job_titles.php?id=$id\" class=\"btn btn-warning\">Cancel</a></div>";
