...
<form class="d-flex" role="search" method="get">
    <input class="form-control me-2" type="search" placeholder="Search for a prayer" aria-label="Search" name="search" value="<?php if ((isset($_GET['search'])) && (strlen($_GET['search']) > 0)) {
                                                                                                                                    echo $_GET['search'];
                                                                                                                                } ?>">
    <button class="btn btn-outline-primary" type="submit"><?= I_SEARCH ?> search</button>
</form>
<div class="mt-3">
    <a type="button" class="btn btn-primary" href="<?php echo URLROOT; ?>/prayers/add">
        <?= I_ADD_SIGN ?> new prayer</a>
</div>
