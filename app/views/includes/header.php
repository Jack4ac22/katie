        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
            ...
            <div class="offcanvas-body">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">new language</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link">new time zone</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link">new comment</a>
                    </li>
                </ul>
                </p>
            </div>
    ...
    <?php else : ?>
        <div class="container text-center">
            ...
            <div class="col align-self-end">
                <div class="container"><a href="<?php echo URLROOT . '/users/login'; ?>" class="btn btn-primary btn-lg"><i class="fa-solid fa-lock"></i> login</a></div>
            </div>
