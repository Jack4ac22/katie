  ...
  <a href="<?php echo URLROOT; ?>/groups/<?= $data['id'] ?>" class="btn btn-light"><?= I_ARROW_L ?> Back to <?= $data['title'] ?> group.</a>
  <div class="card card-body bg-light mt-5">
      <h2>Edit group</h2>
      <p>click on update after correcting or updating the desired field.</p>
      <form action="<?php echo URLROOT; ?>/groups/edit/<?php echo $data['id']; ?>" method="post">
