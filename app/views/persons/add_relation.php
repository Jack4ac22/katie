...
<div class="card card-body bg-light mt-5">
    <h2>Add personal relationship</h2>
    <p>Fill up the form to add new personal relationship.</p>
    <form action="<?php echo URLROOT; ?>/persons/add_relation/" <?= $data['p_id1'] ?> method="post">
        ...
        <div class="form-floating mb-3">
            <button type="submit" class="btn btn-primary btn-block"><?= I_PERSON ?> relate <?= I_PERSON ?></button>
        </div>
    </form>
</div>
