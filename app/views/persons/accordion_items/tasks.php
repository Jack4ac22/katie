     ...
     <div id="person_pannel_open-collapse_tasks" class="accordion-collapse collapse" aria-labelledby="person_pannel_open-heading_tasks">
         <div class="accordion-body">
             <?php if (isset(($data['person']['tas_count'])) && ($data['person']['tas_count'] > 0)) : ?>
                 ...
                 <a class="btn btn-primary" href="<?php echo URLROOT . '/tasks/show_person/' . $data['person']['person']->id; ?>">check all the tasks</a>

                 <div class="row justify-content-between">
                     <?php foreach ($data['person']['tasks'] as $task) : ?>
                         <?php if ($task->status == "show") : ?>
             ...
             <?php else : ?>
                 <div class="alert alert-warning" role="alert">
                     ...
                     <p>You can check the <a href="<?= URLROOT ?>/tasks/show_person/<?= $data['person']['person']->id ?>" class="alert-link">total personal tsks page</a> to check the hidden prayers. </p>
                     <hr>
